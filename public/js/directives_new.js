(function() {
  angular.module("Museum.directives", []).directive("audioplayer", function() {
    return {
      restrict: "E",
      replace: true,
      require: "?ngModel",
  ...
  angular.module("Museum.directives").directive("buttonFileUpload", function() {
    return {
      restrict: "A",
  ...
  angular.module("Museum.directives").directive('canDragAndDrop', function(errorProcessing, $i18next) {
    return {
      restrict: 'A',
      scope: {
        model: '=model',
  ...
  angular.module("Museum.directives").directive('deleteMedia', function(storySetValidation, $http) {
    return {
      restrict: 'A',
      scope: {
        model: '=parent',
  ...
  angular.module("Museum.directives").directive('dragAndDropInit', function(uploadHelpers) {
    return {
      link: function(scope, element, attrs) {
  ...
  angular.module("Museum.directives").directive('dropDownEdit', function($timeout, $http) {
    return {
      restrict: 'A',
      link: function(scope, element, attrs) {
  ...
  angular.module("Museum.directives").directive('droppable', function($http, errorProcessing, $i18next, imageMappingHelpers) {
    return {
      restrict: 'A',
      link: function(scope, element, attrs) {
        element = $(element);
  ...
  angular.module("Museum.directives").directive('errorNotification', function(errorProcessing) {
    return {
      restrict: "E",
      replace: true,
      transclude: true,
  ...
  angular.module("Museum.directives").directive('exhibitsSortable', function($http, errorProcessing, backendWrapper, $i18next) {
    return {
      restrict: 'A',
      link: function(scope, element, attrs) {
  ...
  angular.module("Museum.directives").directive("ngFocus", function($timeout) {
    return function(scope, elem, attrs) {
  ...
  angular.module("Museum.directives").directive("focusMe", function($timeout, $parse) {
    return {
      link: function(scope, element, attrs) {
        var model;
  ...
  angular.module("Museum.directives").directive("stopEvent", function() {
    return {
      link: function(scope, element, attr) {
  ...
  angular.module("Museum.directives").directive("resizer", function() {
    return {
      restrict: "A",
      link: function(scope, element, attr) {
        var elem;
  ...
  angular.module("Museum.directives").directive("toggleMenu", function() {
    return {
      restrict: "A",
      link: function(scope, element, attr) {
        var elem;
  ...
  angular.module("Museum.directives").directive("toggleFilters", function() {
    return {
      restrict: "A",
      link: function(scope, element, attr) {
        var elem;
  ...
  angular.module("Museum.directives").directive('postRender', function($timeout) {
    return {
      restrict: 'A',
      link: function(scope, element, attrs) {
        var opener;
  ...
  angular.module("Museum.directives").directive('jsDraggable', function($rootScope, $i18next, imageMappingHelpers) {
    return {
      restrict: 'A',
      link: function(scope, element, attrs) {
        var weight_calc;
  ...
  angular.module("Museum.directives").directive("langList", function($timeout) {
    return {
      restrict: "E",
      replace: true,
      transclude: true,
  ...
  angular.module("Museum.directives").directive('lightboxCropper', function($http, errorProcessing, $i18next) {
    return {
      restrict: "E",
      replace: true,
      transclude: true,
  ...
  angular.module("Museum.directives").directive("museumSearch", function() {
    return {
      restrict: "E",
      replace: true,
      transclude: true,
  ...
  angular.module("Museum.directives").directive("newLangSwitch", function($rootScope) {
    return {
      restrict: "E",
      replace: true,
      scope: {
  ...
  angular.module("Museum.directives").directive('openLightbox', function() {
    return {
      restrict: 'A',
      link: function(scope, element, attrs) {
        var lightbox, parent;
  ...
  angular.module("Museum.directives").directive("placeholderfield", function($timeout) {
    return {
      restrict: "E",
      replace: true,
      require: "?ngModel",
  ...
  angular.module("Museum.directives").directive("placeholdertextarea", function($timeout, storySetValidation, $i18next) {
    return {
      restrict: "E",
      replace: true,
      require: "?ngModel",
  ...
  angular.module("Museum.directives").directive("player", function() {
    return {
      restrict: "E",
      replace: true,
      require: "?ngModel",
  ...
  angular.module("Museum.directives").directive("quizanswer", function() {
    return {
      restrict: "E",
      replace: true,
      require: "?ngModel",
  ...
  angular.module("Museum.directives").directive('sortable', function($http, errorProcessing, imageMappingHelpers, $i18next) {
    return {
      restrict: 'A',
      scope: {
        images: "=sortable",
  ...
  angular.module("Museum.directives").directive("statusIndicator", function() {
    return {
      restrict: "E",
      replace: true,
      require: "?ngModel",
  ...
  angular.module("Museum.directives").directive('switchToggle', function($timeout, $i18next) {
    return {
      restrict: 'A',
  ...
  angular.module("Museum.directives").directive("switchpub", function($timeout) {
    return {
      restrict: "E",
      replace: true,
      transclude: true,
  ...
  angular.module("Museum.directives").directive("switchpubitem", function($timeout, storySetValidation, $i18next) {
    return {
      restrict: "E",
      replace: true,
      transclude: true,
  ...
  angular.module("Museum.directives").directive('toTop', function(errorProcessing) {
    return {
      restrict: "E",
      replace: true,
      transclude: true,
  ...
  angular.module("Museum.directives").directive('urlUpload', function($http, uploadHelpers) {
    return {
      restrict: 'A',
      link: function(scope, element, attrs) {
        var testRegex;
